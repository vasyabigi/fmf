...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'ExtraFlatPageImage.is_active'
        db.delete_column('flatpages_extra_extraflatpageimage', 'is_active')


    def backwards(self, orm):
        
        # Adding field 'ExtraFlatPageImage.is_active'
        db.add_column('flatpages_extra_extraflatpageimage', 'is_active', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)
