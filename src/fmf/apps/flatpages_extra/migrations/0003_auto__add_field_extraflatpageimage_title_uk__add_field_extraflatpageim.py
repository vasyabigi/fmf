...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ExtraFlatPageImage.title_uk'
        db.add_column('flatpages_extra_extraflatpageimage', 'title_uk', self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True), keep_default=False)

        # Adding field 'ExtraFlatPageImage.title_en'
        db.add_column('flatpages_extra_extraflatpageimage', 'title_en', self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ExtraFlatPageImage.title_uk'
        db.delete_column('flatpages_extra_extraflatpageimage', 'title_uk')

        # Deleting field 'ExtraFlatPageImage.title_en'
        db.delete_column('flatpages_extra_extraflatpageimage', 'title_en')
