...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'IndexSliderImage.section'
        db.add_column('core_indexsliderimage', 'section',
                      self.gf('django.db.models.fields.related.OneToOneField')(to=orm['sections.Section'], unique=True, null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'IndexSliderImage.section'
        db.delete_column('core_indexsliderimage', 'section_id')
