...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Article.section'
        db.alter_column('sections_article', 'section_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['sections.Section']))


    def backwards(self, orm):
        
        # Changing field 'Article.section'
        db.alter_column('sections_article', 'section_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['sections.Section']))
