...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Event.date_to'
        db.alter_column('news_event', 'date_to', self.gf('django.db.models.fields.DateField')(null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Event.date_to'
        db.alter_column('news_event', 'date_to', self.gf('django.db.models.fields.DateField')(default=datetime.date(2011, 12, 22)))
